...
Consider to also install debug_mysql_db if you want to debug the generated SQL queries or track the PHP errors in the table sys_log.
...
The TYPO3 devLog function is supported also.
